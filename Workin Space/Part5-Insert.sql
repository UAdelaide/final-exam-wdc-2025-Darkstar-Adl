...
((SELECT id FROM dogs WHERE name = "Scooby"), "2025-06-20 08:30:00", 45, "Beachside Ave", "accepted"),
((SELECT id FROM dogs WHERE name = "Knine"), "2025-06-21 01:30:00", , "Beachside Ave", "accepted"),
