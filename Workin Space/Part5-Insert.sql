...
((SELECT id FROM dogs WHERE name = "Scooby"), "2025-06-10 09:30:00", 45, "Beachside Ave", "accepted"),
((SELECT id FROM dogs WHERE name = "Knine"), "2025-06-10 09:30:00", 45, "Beachside Ave", "accepted"),
((SELECT id FROM dogs WHERE name = "Bella"), "2025-06-10 09:30:00", 45, "Beachside Ave", "accepted"),
